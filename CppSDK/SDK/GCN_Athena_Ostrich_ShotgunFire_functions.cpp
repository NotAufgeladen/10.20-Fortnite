...
#include "GCN_Athena_Ostrich_ShotgunFire_classes.hpp"
#include "GCN_Athena_Ostrich_ShotgunFire_parameters.hpp"
...
void UGCN_Athena_Ostrich_ShotgunFire_C::MeterFlare()
{
...
void UGCN_Athena_Ostrich_ShotgunFire_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Athena_Ostrich_ShotgunFire_C_OnBurst Parms{};
