...
void UPurchaseHistoryScreen_C::OnInputMethodChanged(ECommonInputType bNewInputType)
{
	...
	Params::PurchaseHistoryScreen_C_OnInputMethodChanged Parms{};
...
void UPurchaseHistoryScreen_C::BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::PurchaseHistoryScreen_C_BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_2_CommonButtonClicked__DelegateSignature Parms{};
...
void UPurchaseHistoryScreen_C::OnOpenSubmitRequest(bool bIsSelectionTokenlessRefundable)
{
	...
	Params::PurchaseHistoryScreen_C_OnOpenSubmitRequest Parms{};
