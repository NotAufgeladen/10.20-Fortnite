...
DUMPER7_ASSERTS_AthenaSeasonBPTrackerWidget_C_ExecuteUbergraph_AthenaSeasonBPTrackerWidget;

// Function AthenaSeasonBPTrackerWidget.AthenaSeasonBPTrackerWidget_C.FadOutHowToMission
// 0x0008 (0x0008 - 0x0000)
struct AthenaSeasonBPTrackerWidget_C_FadOutHowToMission final
{
public:
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_AthenaSeasonBPTrackerWidget_C_FadOutHowToMission;
...
DUMPER7_ASSERTS_AthenaSeasonBPTrackerWidget_C_OnAccountInfoChanged;

// Function AthenaSeasonBPTrackerWidget.AthenaSeasonBPTrackerWidget_C.ShowHowToMission
// 0x0008 (0x0008 - 0x0000)
struct AthenaSeasonBPTrackerWidget_C_ShowHowToMission final
{
public:
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0000(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_AthenaSeasonBPTrackerWidget_C_ShowHowToMission;
