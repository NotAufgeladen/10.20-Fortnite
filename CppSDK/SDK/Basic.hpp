...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0647AFB8;
	constexpr int32 AppendString      = 0x02186200;
	constexpr int32 GNames            = 0x05CA3F40;
	constexpr int32 GWorld            = 0x06580D20;
	constexpr int32 ProcessEvent      = 0x02329170;
