...
// Parameters:
// const class AActor*&                    Other                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABGA_Athena_WithGravity_Parent_C::OnHit(const class AActor*& Other, const struct FVector& HitNormal, const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_Athena_WithGravity_Parent_C", "OnHit");

	Params::BGA_Athena_WithGravity_Parent_C_OnHit Parms{};
