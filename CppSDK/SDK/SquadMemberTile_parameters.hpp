...
public:
	...
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAthenaTeamDisplayInfo                 CallFunc_GetSquadDisplayInfo_ReturnValue;          // 0x0028(0x0088)()
	bool                                          CallFunc_IsCurrentMemberLocal_ReturnValue;         // 0x00B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EGameReadiness                                K2Node_Event_ReadyStatus;                          // 0x00B2(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_bHasValidMember;                      // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          K2Node_Event_bIsInFrontend;                        // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsCurrentMemberInFrontend_ReturnValue;    // 0x0109(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
