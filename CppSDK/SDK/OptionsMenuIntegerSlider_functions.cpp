...
void UOptionsMenuIntegerSlider_C::ConvertSliderValueToSettingsValue(float SliderValue_0, float* SettingsValue)
{
	static class UFunction* Func = nullptr;
...
void UOptionsMenuIntegerSlider_C::ConvertSettingsValueToSliderValue(float SettingsValue, float* SliderValue_0)
{
	static class UFunction* Func = nullptr;
