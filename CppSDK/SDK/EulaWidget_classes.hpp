...
{
public:
	TMulticastInlineDelegate<void(bool Accepted)> OnEulaResponse;                                    // 0x0358(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
