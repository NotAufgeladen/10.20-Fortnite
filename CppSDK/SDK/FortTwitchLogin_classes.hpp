...
public:
	...
	TMulticastInlineDelegate<void(class FText NewTooltipText)> OnRequestToolTipChange;               // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
