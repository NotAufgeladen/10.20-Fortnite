...
DUMPER7_ASSERTS_BuildWatermark_C_SetTextCollapseIfDefault;
...
public:
	...
	class FString                                 CallFunc_GetCalendarOffsetString_OutString;        // 0x0020(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetCalendarOffsetString_ReturnValue;      // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_31[0x7];                                       // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_StringToText_ReturnValue;            // 0x0038(0x0018)()
};
DUMPER7_ASSERTS_BuildWatermark_C_UpdateCalenderOffset;
