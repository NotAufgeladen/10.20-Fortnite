...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Ninja_SwordHitsHeal_C;           // 0x0A78(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		STATIC_NAME_IMPL(L"GA_Ninja_SwordHitsHeal_C")
	}
