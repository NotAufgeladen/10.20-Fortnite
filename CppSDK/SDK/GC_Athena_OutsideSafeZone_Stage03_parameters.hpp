...
DUMPER7_ASSERTS_GC_Athena_OutsideSafeZone_Stage03_C_RemoveStormAudio;
...
DUMPER7_ASSERTS_GC_Athena_OutsideSafeZone_Stage03_C_AddStormAudio;
...
DUMPER7_ASSERTS_GC_Athena_OutsideSafeZone_Stage03_C_OnRemoval;
...
DUMPER7_ASSERTS_GC_Athena_OutsideSafeZone_Stage03_C_OnApplication;
...
public:
	...
	class AActor*                                 K2Node_Event_MyTarget_2;                           // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                 K2Node_Event_Parameters_2;                         // 0x0148(0x00B8)(ConstParm, ContainsInstancedReference)
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents_2;                 // 0x0200(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents_2;                    // 0x0210(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	float                                         CallFunc_Lerp_ReturnValue_1;                       // 0x0238(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayCueParameters                 K2Node_Event_Parameters_1;                         // 0x0248(0x00B8)(ConstParm, ContainsInstancedReference)
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents_1;                 // 0x0300(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents_1;                    // 0x0310(0x0010)(ConstParm, ZeroConstructor, ReferenceParm)
	class UCameraShake*                           K2Node_Event_BurstCameraShakeInstance_1;           // 0x0320(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ADecalActor*                            K2Node_Event_BurstDecalInstance_1;                 // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
