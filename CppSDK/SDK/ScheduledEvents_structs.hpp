...
public:
	...
	double                                        CacheIntervalMins;                                 // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, struct FEventsTimeline>   Channels;                                          // 0x0018(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
};
