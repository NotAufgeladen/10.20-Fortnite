...
#include "GCNL_Athena_Ostrich_Dash_Cooldown_End_classes.hpp"
#include "GCNL_Athena_Ostrich_Dash_Cooldown_End_parameters.hpp"
...
void AGCNL_Athena_Ostrich_Dash_Cooldown_End_C::OnRemoval(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Ostrich_Dash_Cooldown_End_C", "OnRemoval");

	Params::GCNL_Athena_Ostrich_Dash_Cooldown_End_C_OnRemoval Parms{};
...
void AGCNL_Athena_Ostrich_Dash_Cooldown_End_C::ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_Ostrich_Dash_Cooldown_End_C", "ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End");

	Params::GCNL_Athena_Ostrich_Dash_Cooldown_End_C_ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End Parms{};
