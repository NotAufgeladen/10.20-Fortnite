...
void AB_Prj_Athena_TNT_C::OnBounce(const struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_TNT_C", "OnBounce");

	Params::B_Prj_Athena_TNT_C_OnBounce Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   DetonationTime_0                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AB_Prj_Athena_TNT_C::Event_StartFuse(float DetonationTime_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DetonationTime_0 = DetonationTime_0;
...
void AB_Prj_Athena_TNT_C::OnRep_DetonationTime()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("B_Prj_Athena_TNT_C", "OnRep_DetonationTime");
