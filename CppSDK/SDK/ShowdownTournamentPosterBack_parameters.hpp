...
public:
	...
	class UTournamentDateEntry_C*                 K2Node_DynamicCast_AsTournament_Date_Entry;        // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetTournamentId_ReturnValue_1;            // 0x0050(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_TextToUpper_ReturnValue_1;                // 0x00F0(0x0018)()
	class FText                                   CallFunc_TextToUpper_ReturnValue_2;                // 0x0108(0x0018)()
	class FText                                   CallFunc_TextToUpper_ReturnValue_3;                // 0x0120(0x0018)()
	class FText                                   CallFunc_TextToUpper_ReturnValue_4;                // 0x0138(0x0018)()
	TArray<class FString>                         CallFunc_GetTournamentEvents_ReturnValue;          // 0x0150(0x0010)(ZeroConstructor, ReferenceParm)
	...
	class UTournamentDateEntry_C*                 CallFunc_Create_ReturnValue;                       // 0x0180(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUniformGridSlot*                       CallFunc_AddChildToUniformGrid_ReturnValue;        // 0x0188(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable;                                // 0x0190(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable_1;                              // 0x0191(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x0192(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         Temp_float_Variable_1;                             // 0x0198(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable_1;                              // 0x019C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_Variable_2;                              // 0x019D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_19E[0x2];                                      // 0x019E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetTournamentBestScore_ReturnValue;       // 0x01A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         K2Node_Select_Default_2;                           // 0x01C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
