...
#include "GCN_Athena_Ostrich_Enter_Driver_classes.hpp"
#include "GCN_Athena_Ostrich_Enter_Driver_parameters.hpp"
...
bool UGCN_Athena_Ostrich_Enter_Driver_C::OnExecute(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters) const
{
	...
	Params::GCN_Athena_Ostrich_Enter_Driver_C_OnExecute Parms{};
...
void UGCN_Athena_Ostrich_Enter_Driver_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Athena_Ostrich_Enter_Driver_C_OnBurst Parms{};
