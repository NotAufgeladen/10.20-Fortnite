...
public:
	...
	struct FGameplayTag                           T_PurpleStuff;                                     // 0x0A34(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A3C[0x4];                                      // 0x0A3C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  T_NotReady;                                        // 0x0A40(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("GA_Athena_PurpleStuff_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"GA_Athena_PurpleStuff_C")
	}
...
DUMPER7_ASSERTS_UGA_Athena_PurpleStuff_C;
