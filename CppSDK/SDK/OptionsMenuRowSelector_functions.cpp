...
void UOptionsMenuRowSelector_C::SetFontSize(class UCommonTextBlock* Text, int32 DefaultFontSize, int32 MobileFontSize)
{
	static class UFunction* Func = nullptr;
	...
	Params::OptionsMenuRowSelector_C_SetFontSize Parms{};
...
void UOptionsMenuRowSelector_C::SetToolTipSize(const struct FVector2D& DefaultSize, const struct FVector2D& MobileSize)
{
	static class UFunction* Func = nullptr;
	...
	Params::OptionsMenuRowSelector_C_SetToolTipSize Parms{};
