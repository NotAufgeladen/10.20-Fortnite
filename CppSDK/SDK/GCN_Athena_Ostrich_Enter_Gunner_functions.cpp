...
#include "GCN_Athena_Ostrich_Enter_Gunner_classes.hpp"
#include "GCN_Athena_Ostrich_Enter_Gunner_parameters.hpp"
...
bool UGCN_Athena_Ostrich_Enter_Gunner_C::OnExecute(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Ostrich_Enter_Gunner_C", "OnExecute");

	Params::GCN_Athena_Ostrich_Enter_Gunner_C_OnExecute Parms{};
