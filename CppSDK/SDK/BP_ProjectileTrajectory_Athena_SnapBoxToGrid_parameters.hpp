...
public:
	...
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue_1;   // 0x0140(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USplineMeshComponent*                   CallFunc_Array_Get_Item_4;                         // 0x0188(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetLocationAtSplinePoint_ReturnValue;     // 0x0190(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetLeaveTangentAtSplinePoint_ReturnValue; // 0x019C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_GetArriveTangentAtSplinePoint_ReturnValue; // 0x01B0(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetLocationAtSplinePoint_ReturnValue_1;   // 0x01BC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_ExecuteUbergraph_BP_ProjectileTrajectory_Athena_SnapBoxToGrid;
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_SetTrajectorySpline;
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_ReceiveActorBeginOverlap;
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_UserConstructionScript;
...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult_1;     // 0x014C(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_HandleGridSnapUpdates;
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_UpdateScaleForPlayset;
...
DUMPER7_ASSERTS_BP_ProjectileTrajectory_Athena_SnapBoxToGrid_C_GetPlaysetFromController;
