...
bool AGCL_TNT_Fuse_Cook_C::OnRemove(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCL_TNT_Fuse_Cook_C", "OnRemove");

	Params::GCL_TNT_Fuse_Cook_C_OnRemove Parms{};
