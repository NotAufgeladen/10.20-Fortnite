...
public:
	...
	TMulticastInlineDelegate<void()>              OnAudioFinished;                                   // 0x0260(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
	TMulticastInlineDelegate<void(const class USoundWave* PlayingSoundWave, const float PlaybackPercent)> OnAudioPlaybackPercent; // 0x0270(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPrivate)
