...
#include "GCN_Athena_Ostrich_JumpSlam_Land_classes.hpp"
#include "GCN_Athena_Ostrich_JumpSlam_Land_parameters.hpp"


namespace SDK
{

// Function GCN_Athena_Ostrich_JumpSlam_Land.GCN_Athena_Ostrich_JumpSlam_Land_C.OnBurst
...
void UGCN_Athena_Ostrich_JumpSlam_Land_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_Athena_Ostrich_JumpSlam_Land_C", "OnBurst");

	Params::GCN_Athena_Ostrich_JumpSlam_Land_C_OnBurst Parms{};
