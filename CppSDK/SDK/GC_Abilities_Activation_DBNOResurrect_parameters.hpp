...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x01C8(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                                CallFunc_MakeVector_ReturnValue_1;                 // 0x0254(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GC_Abilities_Activation_DBNOResurrect_C_OnBurst;
