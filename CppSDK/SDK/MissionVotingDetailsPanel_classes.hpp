...
public:
	...
	class UWidgetAnimation*                       VoteResultAnimation_UNUSED;                        // 0x0288(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UImage*                                 TimeTypeIcon_1;                                    // 0x0350(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                 Vote_Result_Glow;                                  // 0x0358(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TMulticastInlineDelegate<void()>              OnRecepientVoted;                                  // 0x03C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnVoteLockedOut;                                   // 0x0428(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(EFortVoteType VoteType, bool Success)> OnVoteResultFinished;       // 0x0450(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnMissionActivateNoVote;                           // 0x0470(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("MissionVotingDetailsPanel_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"MissionVotingDetailsPanel_C")
	}
...
DUMPER7_ASSERTS_UMissionVotingDetailsPanel_C;
