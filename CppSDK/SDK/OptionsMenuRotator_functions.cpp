...
// Function OptionsMenuRotator.OptionsMenuRotator_C.ClearDisabledState
// (BlueprintCallable, BlueprintEvent)

void UOptionsMenuRotator_C::ClearDisabledState()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenuRotator_C", "ClearDisabledState");
...
void UOptionsMenuRotator_C::SetControlsEnabled(bool bEnabled, const class FText& DisabledReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenuRotator_C", "SetControlsEnabled");

	Params::OptionsMenuRotator_C_SetControlsEnabled Parms{};
...
void UOptionsMenuRotator_C::SetFontSize(class UCommonTextBlock* Text, int32 DefaultSize, int32 MobileSize)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenuRotator_C", "SetFontSize");

	Params::OptionsMenuRotator_C_SetFontSize Parms{};
