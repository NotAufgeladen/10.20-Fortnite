...
void UBP_AmbientAudioController_C::On_Game_Phase_Step_Change(const TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, EAthenaGamePhaseStep GamePhaseStep)
{
	static class UFunction* Func = nullptr;
