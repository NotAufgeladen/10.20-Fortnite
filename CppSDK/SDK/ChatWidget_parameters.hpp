...
DUMPER7_ASSERTS_ChatWidget_C_HandlePreShowConfirmationDialog;
...
DUMPER7_ASSERTS_ChatWidget_C_HandleControllerSendMessagePressed;
...
DUMPER7_ASSERTS_ChatWidget_C_HandleRightTabPressed;
...
DUMPER7_ASSERTS_ChatWidget_C_HandleLeftTabPressed;
...
DUMPER7_ASSERTS_ChatWidget_C_HandleExitPressed;
...
public:
	...
	ECommonInputType                              K2Node_CustomEvent_InputType;                      // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool* bPassThrough)>           K2Node_CreateDelegate_OutputDelegate_3;            // 0x0038(0x0010)(ZeroConstructor, NoDestructor)
};
