...
public:
	...
	class UItemCraftingIngredientList_C*          DetailsWidget_ItemCraftingIngredientsList;         // 0x0290(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
