...
struct GCNL_Athena_Ostrich_Dash_Cooldown_End_C_OnRemoval final
{
public:
...
DUMPER7_ASSERTS_GCNL_Athena_Ostrich_Dash_Cooldown_End_C_OnRemoval;
...
struct GCNL_Athena_Ostrich_Dash_Cooldown_End_C_ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End final
{
public:
	...
	class USkeletalMeshComponent*                 CallFunc_GetMechMesh_ReturnValue;                  // 0x00F8(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_K2_AttachToComponent_ReturnValue_1;       // 0x0111(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_112[0x6];                                      // 0x0112(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class ATestMechVehicle_C*                     K2Node_DynamicCast_AsTest_Mech_Vehicle;            // 0x0118(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_GCNL_Athena_Ostrich_Dash_Cooldown_End_C_ExecuteUbergraph_GCNL_Athena_Ostrich_Dash_Cooldown_End;
